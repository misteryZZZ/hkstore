		...
		<div class="payment-methods w-100">
		  ...
		  <div class="ui unstackable items" v-if="getTotalAmount() > 0 || customAmount > 0">
			...
			<div class="cart-payment cart-checkout">
				<form action="{{ route('home.checkout.payment') }}" method="post" id="form-checkout" class="ui big form" :class="{'d-none': !/^iyzico|paystack|payhere|coinpayments|sslcommerz|flutterwave$/.test(paymentProcessor) || ({{ var_export(\Auth::check()) }} && paymentProcessor == 'paystack')}">
					@csrf
