...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!-- Spacing CSS -->
		...
		<script type="application/javascript" src="{{ asset_('assets/jquery-custom-scrollbar/jquery.custom-scrollbar.min.js') }}"></script>

		<link rel="stylesheet" href="{{ asset_('assets/jquery-custom-scrollbar/jquery.custom-scrollbar.css') }}">
