<div class="ui unstackable secondary menu top attached py-0 {{ route_is('home') ? 'home' : '' }}" id="top-menu">
  ...
  <div class="right menu pr-1"> 
    ...
    <div class="item ui dropdown categories">
      <div class="toggler">
        ...
        <div class="text mt-1-hf">{{ __('Categories') }}</div>
      </div>
    ...
    <div class="item notifications dropdown">
      <div class="toggler">
        ...
        <div class="text mt-1-hf">{{ __('Notifications') }}</div>
      </div>
    ...
    <div class="item cart dropdown">
      <div class="toggler">
        ...
        <div class="text mt-1-hf">{{ __('Shopping cart') }}</div>
      </div>
  ...
  <div class="wrapper">
    ...
    <div class="footer">
      <div class="ui spaced buttons">
        <a href="{{ config('app.facebook') }}" class="ui basic icon button"><i class="large facebook icon"></i></a>
        <a href="{{ config('app.twitter') }}" class="ui basic icon button"><i class="large twitter icon"></i></a>
        <a href="{{ config('app.pinterest') }}" class="ui basic icon button"><i class="large pinterest icon"></i></a>
        <a href="{{ config('app.youtube') }}" class="ui basic icon button"><i class="large youtube icon"></i></a>
        <a href="{{ config('app.tumblr') }}" class="ui basic icon button"><i class="large tumblr icon"></i></a>
      </div>

      <p>{{ config('app.name') }} © {{ date('Y') }} {{ __('all right reserved') }}</p>
    </div>
  </div>
</div>
